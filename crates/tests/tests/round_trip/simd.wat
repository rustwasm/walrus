...
;;   (func $v128.shuffle (export "v128.shuffle") (param v128) (result v128)
;;     local.get 0
;;     v128.shuffle
;;   )
...
(; CHECK-ALL:
  (module
    ...
    (func $f32x4.abs (type 15) (param v128) (result v128)
      local.get 0
      f32x4.abs)
    (func $f32x4.neg (type 15) (param v128) (result v128)
      local.get 0
      f32x4.neg)
    (func $f32x4.sqrt (type 15) (param v128) (result v128)
      local.get 0
      f32x4.sqrt)
    (func $f64x2.abs (type 15) (param v128) (result v128)
      local.get 0
      f64x2.abs)
    (func $f64x2.neg (type 15) (param v128) (result v128)
      local.get 0
      f64x2.neg)
    (func $f64x2.sqrt (type 15) (param v128) (result v128)
      local.get 0
      f64x2.sqrt)
    (func $i32x4_trunc_s_f32x4_sat (type 15) (param v128) (result v128)
      local.get 0
      i32x4.trunc_sat_f32x4_s)
    (func $i32x4_trunc_u_f32x4_sat (type 15) (param v128) (result v128)
      local.get 0
      i32x4.trunc_sat_f32x4_u)
    (func $i64x2_trunc_s_f64x2_sat (type 15) (param v128) (result v128)
      local.get 0
      i64x2.trunc_sat_f64x2_s)
    (func $i64x2_trunc_u_f64x2_sat (type 15) (param v128) (result v128)
      local.get 0
      i64x2.trunc_sat_f64x2_u)
    (func $f32x4.convert_i32x4_s (type 15) (param v128) (result v128)
      local.get 0
      f32x4.convert_i32x4_s)
    (func $f32x4.convert_i32x4_u (type 15) (param v128) (result v128)
      local.get 0
      f32x4.convert_i32x4_u)
    (func $f64x2.convert_i64x2_s (type 15) (param v128) (result v128)
      local.get 0
      f64x2.convert_i64x2_s)
    (func $f64x2.convert_i64x2_u (type 15) (param v128) (result v128)
      local.get 0
      f64x2.convert_i64x2_u)
